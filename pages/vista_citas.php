...
<div id="titulo">
        ...
        <div id="mas">
            <a href="adm_añadir_cita.html"><i class="fa-solid fa-plus" ></i></a>
        </div>
        <br>
        <table class="tabla">
            <tr>
            ...
            <tr>
                ...
                <td><a href="adm_editar_cita.html"><i class="fa-solid fa-pen" ></i></a>  <a href="cita.html"><i class="fa-solid fa-trash" ></i></a>
            </tr>
            <tr>
                <td>2</td>
